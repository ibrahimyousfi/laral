...
<header class="sticky top-0 z-30 h-14 px-4 flex items-center justify-between gap-4 bg-white border-b border-gray-200">
    ...
    <div class="shrink-0">
        ...
        @elseif(isset($addUrl))
            <a href="{{ $addUrl }}" class="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gray-900 text-white hover:bg-gray-800 transition-colors relative overflow-hidden before:absolute before:inset-0 before:rounded-full before:scale-0 hover:before:scale-100 before:opacity-0 hover:before:opacity-100 before:bg-black/10 before:transition-all before:duration-200" aria-label="Add">
