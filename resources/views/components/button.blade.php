...
@php
    ...
    $variants = [
        ...
        'secondary' => 'bg-gray-100 text-gray-900 border border-gray-200 focus:ring-gray-400 ' . $hoverCircle,
        'ghost' => 'text-gray-700 hover:bg-gray-100 focus:ring-gray-400 ' . $hoverCircle,
        'danger' => 'bg-red-600 text-white focus:ring-red-500 ' . $hoverCircle,
    ];
    $sizes = [
